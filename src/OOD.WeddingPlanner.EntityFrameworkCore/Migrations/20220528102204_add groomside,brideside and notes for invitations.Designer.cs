...
namespace OOD.WeddingPlanner.Migrations
{
    ...
    [Migration("20220528102204_add groomside,brideside and notes for invitations")]
    partial class addgroomsidebridesideandnotesforinvitations
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OOD.WeddingPlanner.LanguageTexts.LanguageText", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("OOD.WeddingPlanner.TableMenus.TableMenu", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("AppTableMenus", (string)null);
                });
            ...
            modelBuilder.Entity("OOD.WeddingPlanner.Weddings.Wedding", b =>
                {
                    ...
                    b.ToTable("AppWeddings", (string)null);
                });
            ...
            modelBuilder.Entity("OOD.WeddingPlanner.Events.Event", b =>
                {
                    b.HasOne("OOD.WeddingPlanner.Locations.Location", "Location")
                        .WithMany("Events")
            ...
            modelBuilder.Entity("OOD.WeddingPlanner.Invitees.Invitee", b =>
                {
                    b.HasOne("OOD.WeddingPlanner.Invitations.Invitation", "Invitation")
                        .WithMany("Invitees")
